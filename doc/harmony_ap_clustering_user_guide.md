...
|---------------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `DEPLOYMENT_CLUSTERED`    | false      | Enables the clustered mode when set to `true`. Unless this variable is set to `true`, the rest of the clustering configuration variables will be ignored. By enabling this option Access Point will listen on port 8080 (HTTP) instead of 8443 (HTTPS). Required as `true` when used in a cluster, the default value is `false` |
