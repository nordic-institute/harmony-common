...
--  *********************************************************************
--  Change Log: src/main/resources/db/archive/5.0/migration/changelog-42-50-data-migration-single-tenancy-step4.xml
--  Ran at: 5/15/23 12:13 PM
--  Against: null@offline:mysql?changeLogFile=/home/hyoty/projects/niis/harmony-access-point/Core/Domibus-MSH-db/target/liquibase/changelog-42-50-data-migration-single-tenancy-step4.mysql
--  Liquibase version: 4.17.0
--  *********************************************************************

--  Changeset src/main/resources/db/archive/5.0/migration/common/changelog-42-50-data-migration-step4.xml::EDELIVERY-7970-clean-common::Catalin Enache
-- DELIMITER //

DROP TABLE OLD_TB_ALERT
//

DROP TABLE OLD_TB_EVENT
//

DROP TABLE OLD_TB_EVENT_ALERT
//

DROP TABLE OLD_TB_EVENT_PROPERTY
//

DROP TABLE OLD_TB_COMMAND
//

DROP TABLE OLD_TB_COMMAND_PROPERTY
//

DROP TABLE OLD_TB_USER
//

DROP TABLE OLD_TB_USER_PASSWORD_HISTORY
//

DROP TABLE OLD_TB_USER_ROLE
//

DROP TABLE OLD_TB_USER_ROLES
//

DROP TABLE OLD_TB_REV_INFO
//

DROP TABLE OLD_TB_REV_CHANGES
//

DROP TABLE OLD_TB_USER_AUD
//

DROP TABLE OLD_TB_USER_ROLE_AUD
//

DROP TABLE OLD_TB_USER_ROLES_AUD
//

DROP TABLE MIGR_TB_PKS_TIMEZONE_OFFSET
//

DROP TABLE MIGR_TB_PKS_USER_MESSAGE
//

DROP TABLE MIGR_TB_PKS_MESSAGE_INFO
//

DROP TABLE MIGR_TB_PKS_MESSAGE_GROUP
//

DROP TABLE MIGR_TB_PKS_PART_INFO
//

DROP TABLE MIGR_TB_PKS_MESSAGE_ACKNW
//

DROP TABLE MIGR_TB_PKS_SEND_ATTEMPT
//

DROP TABLE MIGR_TB_PKS_ACTION_AUDIT
//

DROP TABLE MIGR_TB_PKS_ALERT
//

DROP TABLE MIGR_TB_PKS_EVENT
//

DROP TABLE MIGR_TB_PKS_AUTH_ENTRY
//

DROP TABLE MIGR_TB_PKS_BACKEND_FILTER
//

DROP TABLE MIGR_TB_PKS_ROUTING_CRITERIA
//

DROP TABLE MIGR_TB_PKS_CERTIFICATE
//

DROP TABLE MIGR_TB_PKS_COMMAND
//

DROP TABLE MIGR_TB_PKS_PM_BUSINESS_PROC
//

DROP TABLE MIGR_TB_PKS_PM_ACTION
//

DROP TABLE MIGR_TB_PKS_PM_AGREEMENT
//

DROP TABLE MIGR_TB_PKS_PM_ERROR_HANDLING
//

DROP TABLE MIGR_TB_PKS_PM_MEP
//

DROP TABLE MIGR_TB_PKS_PM_MEP_BINDING
//

DROP TABLE MIGR_TB_PKS_PM_MESSAGE_PROP
//

DROP TABLE MIGR_TB_PKS_PM_MSG_PROP_SET
//

DROP TABLE MIGR_TB_PKS_PM_PARTY
//

DROP TABLE MIGR_TB_PKS_PM_CONFIGURATION
//

DROP TABLE MIGR_TB_PKS_PM_MPC
//

DROP TABLE MIGR_TB_PKS_PM_PARTY_ID_TYPE
//

DROP TABLE MIGR_TB_PKS_PM_PARTY_ID
//

DROP TABLE MIGR_TB_PKS_PM_PAYLOAD
//

DROP TABLE MIGR_TB_PKS_PM_PAYLOAD_PROF
//

DROP TABLE MIGR_TB_PKS_PM_RECEPTN_AWARNS
//

DROP TABLE MIGR_TB_PKS_PM_RELIABILITY
//

DROP TABLE MIGR_TB_PKS_PM_ROLE
//

DROP TABLE MIGR_TB_PKS_PM_SECURITY
//

DROP TABLE MIGR_TB_PKS_PM_SERVICE
//

DROP TABLE MIGR_TB_PKS_PM_SPLITTING
//

DROP TABLE MIGR_TB_PKS_PM_LEG
//

DROP TABLE MIGR_TB_PKS_PM_PROCESS
//

DROP TABLE MIGR_TB_PKS_PM_CONF_RAW
//

DROP TABLE MIGR_TB_PKS_USER
//

DROP TABLE MIGR_TB_PKS_USER_ROLE
//

DROP TABLE MIGR_TB_PKS_REV_INFO
//
...
--  Changeset src/main/resources/db/archive/5.0/migration/single-tenancy/changelog-42-50-data-migration-step4.xml::EDELIVERY-7970-clean-single-tenancy::Catalin Enache
...
DROP TABLE OLD_TB_SEND_ATTEMPT
//

DROP TABLE OLD_TB_ACTION_AUDIT
//

DROP TABLE OLD_TB_AUTHENTICATION_ENTRY
//

DROP TABLE OLD_TB_PLUGIN_USER_PASSWD_HISTORY
//

DROP TABLE OLD_TB_BACKEND_FILTER
//

DROP TABLE OLD_TB_ROUTING_CRITERIA
//

DROP TABLE OLD_TB_CERTIFICATE
//

DROP TABLE OLD_TB_ENCRYPTION_KEY
//

DROP TABLE OLD_TB_MESSAGE_ACKNW_PROP
//

DROP TABLE OLD_TB_MESSAGING_LOCK
//

DROP TABLE OLD_TB_PM_BUSINESS_PROCESS
//

DROP TABLE OLD_TB_PM_ACTION
//

DROP TABLE OLD_TB_PM_AGREEMENT
//

DROP TABLE OLD_TB_PM_ERROR_HANDLING
//

DROP TABLE OLD_TB_PM_MEP
//

DROP TABLE OLD_TB_PM_MEP_BINDING
//

DROP TABLE OLD_TB_PM_MESSAGE_PROPERTY
//

DROP TABLE OLD_TB_PM_MESSAGE_PROPERTY_SET
//

DROP TABLE OLD_TB_PM_JOIN_PROPERTY_SET
//

DROP TABLE OLD_TB_PM_PARTY
//

DROP TABLE OLD_TB_PM_CONFIGURATION
//

DROP TABLE OLD_TB_PM_MPC
//

DROP TABLE OLD_TB_PM_PARTY_ID_TYPE
//

DROP TABLE OLD_TB_PM_PARTY_IDENTIFIER
//

DROP TABLE OLD_TB_PM_PAYLOAD
//

DROP TABLE OLD_TB_PM_PAYLOAD_PROFILE
//

DROP TABLE OLD_TB_PM_JOIN_PAYLOAD_PROFILE
//

DROP TABLE OLD_TB_PM_RECEPTION_AWARENESS
//

DROP TABLE OLD_TB_PM_RELIABILITY
//

DROP TABLE OLD_TB_PM_ROLE
//

DROP TABLE OLD_TB_PM_SECURITY
//

DROP TABLE OLD_TB_PM_SERVICE
//

DROP TABLE OLD_TB_PM_SPLITTING
//

DROP TABLE OLD_TB_PM_LEG
//

DROP TABLE OLD_TB_PM_LEG_MPC
//

DROP TABLE OLD_TB_PM_PROCESS
//

DROP TABLE OLD_TB_PM_JOIN_PROCESS_INIT_PARTY
//

DROP TABLE OLD_TB_PM_JOIN_PROCESS_LEG
//

DROP TABLE OLD_TB_PM_JOIN_PROCESS_RESP_PARTY
//

DROP TABLE OLD_TB_PM_CONFIGURATION_RAW
//

DROP TABLE OLD_WS_PLUGIN_TB_MESSAGE_LOG
//

DROP TABLE OLD_TB_AUTHENTICATION_ENTRY_AUD
//

DROP TABLE OLD_TB_BACK_RCRITERIA_AUD
//

DROP TABLE OLD_TB_BACKEND_FILTER_AUD
//

DROP TABLE OLD_TB_CERTIFICATE_AUD
//

DROP TABLE OLD_TB_PM_CONFIGURATION_AUD
//

DROP TABLE OLD_TB_PM_CONFIGURATION_RAW_AUD
//

DROP TABLE OLD_TB_PM_PARTY_AUD
//

DROP TABLE OLD_TB_PM_PARTY_ID_TYPE_AUD
//

DROP TABLE OLD_TB_PM_PARTY_IDENTIFIER_AUD
//

DROP TABLE OLD_TB_ROUTING_CRITERIA_AUD
//
